  ...
  <div class="product_image_area">
    <div class="container">
      <div class="row justify-content-center">
          <div class="col-lg-12" style="margin: auto;width: 50%;">
          <div class="product_img_slide owl-carousel" style="margin: auto;width: 50%;;">
            <div class="single_product_img">
              <img src="<?php echo $row['Thumbnail']; ?>" alt="#" class="img-fluid">
            </div>
            <div class="single_product_img">
              <img src="<?php echo $row['image_1']; ?>" alt="#" class="img-fluid">
            </div>
            <div class="single_product_img">
              <img src="<?php echo $row['image_2']; ?>" alt="#" class="img-fluid">
            </div>
          </div>
        </div>
        <div class="col-lg-8">
          <div class="single_product_text text-center">
            ...
            <div class="card_area">
                <div class="price">Price: <?php echo $row['price']; ?> VND</div>
              <div class="add_to_cart">
                  <a href="addtocart.php?id=<?php echo $product_id;?>"> <button class="btn_3" value="<?php echo $product_id;?>">add to cart</button></a>
              </div>
            </div>
          </div>
        </div>
